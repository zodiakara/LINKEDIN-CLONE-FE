  ...
  return (
    <div>
      <div className="activity-section cd width cd ff ">
        ...
        <p className="activity-status fs-16 fw-800">
          {" "}
          User hasn't posted lately
        </p>
        <p className="activity-info fs-14">
          User’s recent posts and comments will be displayed here.
        </p>
      </div>
